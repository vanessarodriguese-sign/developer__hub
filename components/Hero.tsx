  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col w-318 self-center lg:flex-row lg:py-20 lg:ps-123 lg:pe-20 lg:pb-24'>
        ...
        <h5 className='pt-3 pb-8'>Integrate E-Sign’s secure API to your software and enhance agreement automation. Some of the features include:</h5>
        <div className='pb-3'>
        ...
        <div className='flex justify-center'>
          <div className='flex flex-col w-318 gap-8 lg:flex-row lg:px-123 lg:gap-5'>
            <div className='flex flex-col pt-8 lg:w-360 items-center text-center bg-white'>
              ...
              <h5 className='text-center w-262 pb-6'>Use E-signs iframe functionality to generate envelopes from within your own system.</h5>
              <div className='pb-8'>
                <MainButton
                  href=''
            ...
            <div className='flex flex-col pt-8 lg:w-360 items-center text-center bg-white'>
              ...
              <h5 className='text-center w-262 pb-6'>Generate and sign an envelope in one click using API.</h5>
              <div className='pb-8'>
                <MainButton
                  href=''
            ...
            <div className='flex flex-col pt-8 lg:w-360 items-center text-center bg-white'>
              ...
              <h3 className='text-center pb-3'></h3>
              <h5 className='text-center w-262 pb-6'>Retrieve account data using E-signs OAuth functionality.</h5>
              <div className='pb-8'>
                <MainButton
                  href=''
